...
// 3. Copy the ngrok forwarding URL (e.g., https://random-string.ngrok-free.app) and paste it below.
const char* SERVER_URL = "https://<YOUR_NGROK_FORWARDING_URL>.ngrok-free.app/api/getMission?droneId=SB-001";
...
bool initializeSIM() {
  ...
  delay(2000); // Added a delay for stability before setting APN
