...
// --- IMPORTANT! ---
// Replace the example URL below with the HTTPS Forwarding URL from your ngrok terminal.
const char* SERVER_URL = "https://f3a4-103-21-125-0.ngrok-free.app/api/getMission?droneId=SB-001"; 
